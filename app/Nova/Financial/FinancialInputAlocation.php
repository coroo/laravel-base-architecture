...
class FinancialInputAlocation extends Resource
{
    /**
    ...
    public function fields(Request $request)
    {
        return [
            ...
            HiddenField::make('financial_input_type')
                ->defaultValue('alokasi')->onlyOnForms(),
            ...
            Select::make('tipe_alokasi_pendanaan', 'financial_tipe_alokasi_pendanaan')
                ->options(\App\Models\Financial\FinancialTypeAlocationInput::where('shadaqah_alokasi', 'alokasi')->pluck('nama_finansial_alokasi_input', 'kode_finansial_alokasi_input'))
                ->displayUsing(function ($value) {
                    return ucwords(str_replace('-', ' ', $value));
                }),
    ...
    public static function indexQuery(NovaRequest $request, $query)
    {
        return $query->where('debit_kredit','debit')
            ->where('financial_input_type', 'alokasi');
    }
}
