...
class FinancialOutputAlocation extends Resource
{
    /**
    ...
    public static function label() {
        return 'Pengeluaran Dana Alokasi';
    }
    ...
    public function fields(Request $request)
    {
        return [
            HiddenField::make('debit_kredit')
                ->defaultValue('kredit')->onlyOnForms(),
            ID::make()->sortable()->hideFromIndex(),
            Select::make('tipe_alokasi_pendanaan', 'financial_tipe_alokasi_pendanaan')
                ->options(\App\Models\Financial\FinancialTypeAlocationInput::pluck('nama_finansial_alokasi_input', 'kode_finansial_alokasi_input'))
                ->displayUsing(function ($value) {
                    return ucwords(str_replace('-', ' ', $value));
                }),
            Select::make('financial_tipe_alokasi_pengeluaran', 'financial_tipe_alokasi_pengeluaran')
                ->options(\App\Models\Financial\FinancialTypeAlocationOutput::pluck('nama_finansial_alokasi_output', 'kode_finansial_alokasi_output'))
                ->displayUsing(function ($value) {
                    return ucwords(str_replace('-', ' ', $value));
                }),
            ...
            BelongsTo::make('Bank', 'bank', 'App\Nova\Master\MasterBank')->searchable(),
            Text::make('no_rek'),
            Text::make('atas_nama'),
            // Select::make('bank_code', 'bank_code')
            //     ->options(\App\Models\Master\MasterBank::pluck('nama_bank', 'kode_bank')),
    ...
    {
        return $query->where('debit_kredit','kredit');
    }
}
